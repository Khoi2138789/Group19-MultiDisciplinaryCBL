...
def compile_base_map():
    ...
    # Save the entire completed visualization as a highly compressed JSON file
    save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'precompiled_map.json')

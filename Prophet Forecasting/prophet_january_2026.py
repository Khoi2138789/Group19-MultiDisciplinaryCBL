...
def forecast_single_lsoa(lsoa_id, historical_data):
    ...
    try:
        ...
        if len(historical_data) < 2:
            return pd.DataFrame({
                'ds': [pd.to_datetime('2026-01-01')], # Updated to January 2026
                'yhat': [0],
                'yhat_lower': [0],
                'yhat_upper': [0],
                'LSOA_ID': [lsoa_id]
...
if __name__ == '__main__':
    ...
    # Updated training window: January 2023 to December 2025
    start_date_val = pd.to_datetime('2023-01-01')
    end_date_val = pd.to_datetime('2025-12-01')
    ...
    all_predictions = []
    first_batch = True
    output_path = r"C:\Users\20241114\PycharmProjects\PythonProject\Prophet Forecasting\Validation January\january_2026_forecast.csv"
